document.addEventListener("DOMContentLoaded", function() {
    ...
    // Fetch pollution-related news articles from News API
    const apiKey = '65b89511c45b4b28bd936b70a30f4300';
    const apiUrl = `https://newsapi.org/v2/everything?q=pollution&language=en&sortBy=publishedAt&apiKey=${apiKey}`;
